...
export function VersionBadge() {
  ...
  return (
    <div
      className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/[0.08] bg-white/[0.03] mb-7"
      title={
        status === 'online'
    ...
    >
      ...
      <span className="text-[11px] font-mono font-bold tracking-wider text-gray-400">{label}</span>
    </div>
  );
}
