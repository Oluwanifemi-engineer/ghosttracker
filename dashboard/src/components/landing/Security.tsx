      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/[0.03] mb-5">
            <span className="text-[10px] font-mono font-bold tracking-[0.2em] text-white/60">SECURITY</span>
          </div>
        ...
        <div className="relative flex items-center justify-center py-10">
          <div className="relative w-72 h-72 sm:w-80 sm:h-80">
            ...
            <div className="absolute inset-0 rounded-full border border-white/[0.06] animate-slow-spin">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-mag-primary shadow-[0_0_12px_rgba(6,182,212,0.9)]" />
            </div>
            <div
            ...
            >
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-mag-secondary shadow-[0_0_12px_rgba(20,184,166,0.9)]" />
            </div>

            {/* Core shield */}
            <div className="absolute inset-16 rounded-full bg-gradient-to-br from-mag-primary/15 to-mag-secondary/10 border border-white/[0.08] backdrop-blur-xl flex items-center justify-center shadow-2xl shadow-black/50">
