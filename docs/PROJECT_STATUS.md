...
| **Backend Total** | **493** | **✅ All pass** (incl. 4 new this round: dossier command-timeline+alias in `compile_pdf_data`, generate-pdf `device_only` 403, `viewer` PDF 200; 489 prior) |
