...
| **Backend Total** | **469** | **✅ All pass** (incl. 13 new: geofence auto-actions + Zones, CSV export, lost_mode, 2 e2e geofence-exit-flow tests) |
